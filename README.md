# OmniView - Enterprise Monitoring Dashboard

OmniView es una solución integral de monitorización y control para entornos empresariales. Diseñado con una interfaz moderna y profesional, permite la gestión centralizada de equipos, cámaras de seguridad y estado del sistema.

## 🚀 Características Principales

### 📊 Panel de Control Unificado
- **Visión Global:** Resumen instantáneo del estado de la red, servidores y métricas clave.
...
1.  **Clonar el repositorio:**
    ```bash
    git clone https://github.com/Davissss2/PanelEmpresa.git
    cd PanelEmpresa
    ```
